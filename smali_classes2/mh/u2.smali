...
.field static final l:Lmh/r2;

.field static final m:Lmh/r2;


# instance fields
.field protected j:Lmh/v2;
...
.method static constructor <clinit>()V
    ...
    new-array v1, v0, [Ljh/f;

    new-instance v2, Lmh/r2;

    sget-object v3, Ljh/d;->b:Ljava/math/BigInteger;

    invoke-direct {v2, v3}, Lmh/r2;-><init>(Ljava/math/BigInteger;)V

    const/4 v3, 0x0

    aput-object v2, v1, v3

    sput-object v1, Lmh/u2;->k:[Ljh/f;
    ...
    invoke-direct {v1, v2}, Lmh/r2;-><init>(Ljava/math/BigInteger;)V

    sput-object v1, Lmh/u2;->l:Lmh/r2;

    invoke-virtual {v1}, Lmh/r2;->n()Ljh/f;

    move-result-object v0

    check-cast v0, Lmh/r2;

    sput-object v0, Lmh/u2;->m:Lmh/r2;
...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0, v1, v1}, Lmh/v2;-><init>(Ljh/e;Ljh/f;Ljh/f;)V

    iput-object v0, p0, Lmh/u2;->j:Lmh/v2;
    ...
    invoke-virtual {p0, v0}, Lmh/u2;->k(Ljava/math/BigInteger;)Ljh/f;

    move-result-object v0

    iput-object v0, p0, Ljh/e;->b:Ljh/f;

    sget-object v0, Lmh/u2;->l:Lmh/r2;
...
.method protected E(Ljh/f;Ljh/f;[Ljh/f;)Ljh/i;
    ...
    invoke-direct {v0, p0, p1, p2, p3}, Lmh/v2;-><init>(Ljh/e;Ljh/f;Ljh/f;[Ljh/f;)V
...
.method protected c()Ljh/e;
    ...
    new-instance v0, Lmh/u2;

    invoke-direct {v0}, Lmh/u2;-><init>()V
...
.method public e([Ljh/i;II)Ljh/g;
    ...
    iget-object v5, v5, Lmh/r2;->g:[J

    invoke-static {v5, v1, v0, v3}, Lrh/m;->a([JI[JI)V
    ...
    iget-object v4, v4, Lmh/r2;->g:[J

    invoke-static {v4, v1, v0, v3}, Lrh/m;->a([JI[JI)V
    ...
    :cond_0
    new-instance p1, Lmh/u2$a;

    invoke-direct {p1, p0, p3, v0}, Lmh/u2$a;-><init>(Lmh/u2;I[J)V
...
.method protected g(Ljh/f;Ljh/f;)Ljh/i;
    ...
    invoke-direct {v0, p0, p1, p2}, Lmh/v2;-><init>(Ljh/e;Ljh/f;Ljh/f;)V
...
.method public k(Ljava/math/BigInteger;)Ljh/f;
    ...
    new-instance v0, Lmh/r2;

    invoke-direct {v0, p1}, Lmh/r2;-><init>(Ljava/math/BigInteger;)V
...
.method public r()Ljh/i;
    ...
    iget-object v0, p0, Lmh/u2;->j:Lmh/v2;
