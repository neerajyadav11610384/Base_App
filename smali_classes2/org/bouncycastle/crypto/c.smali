.class public final Lorg/bouncycastle/crypto/c;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/bouncycastle/crypto/c;->a:Ljava/security/Permission;
    ...
    sput-object v0, Lorg/bouncycastle/crypto/c;->b:Ljava/security/Permission;
    ...
    sput-object v0, Lorg/bouncycastle/crypto/c;->c:Ljava/security/Permission;

    new-instance v0, Ljava/lang/ThreadLocal;

    invoke-direct {v0}, Ljava/lang/ThreadLocal;-><init>()V

    sput-object v0, Lorg/bouncycastle/crypto/c;->d:Ljava/lang/ThreadLocal;
    ...
    sput-object v0, Lorg/bouncycastle/crypto/c;->e:Ljava/util/Map;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lorg/bouncycastle/crypto/c;->f:Ljava/lang/Object;
    ...
    new-instance v5, Lxg/g;

    const-string v6, "b869c82b35d70e1b1ff91b28e37a62ecdc34409b"

    invoke-static {v6}, Lorg/bouncycastle/util/encoders/b;->b(Ljava/lang/String;)[B

    move-result-object v6

    const/16 v7, 0x7b

    invoke-direct {v5, v6, v7}, Lxg/g;-><init>([BI)V

    invoke-direct {v0, v1, v2, v4, v5}, Lxg/e;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Lxg/g;)V
    ...
    invoke-static {v7}, Lorg/bouncycastle/util/encoders/b;->b(Ljava/lang/String;)[B

    move-result-object v7

    const/16 v8, 0x107

    invoke-direct {v6, v7, v8}, Lxg/g;-><init>([BI)V

    invoke-direct {v1, v2, v4, v5, v6}, Lxg/e;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Lxg/g;)V
    ...
    new-instance v7, Lxg/g;

    const-string v8, "8d5155894229d5e689ee01e6018a237e2cae64cd"

    invoke-static {v8}, Lorg/bouncycastle/util/encoders/b;->b(Ljava/lang/String;)[B

    move-result-object v8

    const/16 v9, 0x5c

    invoke-direct {v7, v8, v9}, Lxg/g;-><init>([BI)V

    invoke-direct {v2, v4, v5, v6, v7}, Lxg/e;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Lxg/g;)V
    ...
    invoke-direct {v3, v8, v9}, Lxg/g;-><init>([BI)V

    invoke-direct {v4, v5, v6, v7, v3}, Lxg/e;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Lxg/g;)V

    sget-object v3, Lorg/bouncycastle/crypto/c$a;->e:Lorg/bouncycastle/crypto/c$a;

    const/4 v5, 0x4

    new-array v6, v5, [Lxg/e;
    ...
    invoke-static {v3, v6}, Lorg/bouncycastle/crypto/c;->c(Lorg/bouncycastle/crypto/c$a;[Ljava/lang/Object;)V

    sget-object v3, Lorg/bouncycastle/crypto/c$a;->d:Lorg/bouncycastle/crypto/c$a;

    new-array v5, v5, [Lxg/b;

    invoke-static {v0}, Lorg/bouncycastle/crypto/c;->e(Lxg/e;)Lxg/b;

    move-result-object v0

    aput-object v0, v5, v7

    invoke-static {v1}, Lorg/bouncycastle/crypto/c;->e(Lxg/e;)Lxg/b;

    move-result-object v0

    aput-object v0, v5, v8

    invoke-static {v2}, Lorg/bouncycastle/crypto/c;->e(Lxg/e;)Lxg/b;

    move-result-object v0

    aput-object v0, v5, v9

    invoke-static {v4}, Lorg/bouncycastle/crypto/c;->e(Lxg/e;)Lxg/b;

    move-result-object v0

    aput-object v0, v5, v10

    invoke-static {v3, v5}, Lorg/bouncycastle/crypto/c;->c(Lorg/bouncycastle/crypto/c$a;[Ljava/lang/Object;)V
...
.method public static b()Ljava/security/SecureRandom;
    ...
    sget-object v0, Lorg/bouncycastle/crypto/c;->f:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lorg/bouncycastle/crypto/c;->g:Ljava/security/SecureRandom;
    ...
    :try_start_1
    sget-object v2, Lorg/bouncycastle/crypto/c;->g:Ljava/security/SecureRandom;

    if-nez v2, :cond_1

    sput-object v1, Lorg/bouncycastle/crypto/c;->g:Ljava/security/SecureRandom;
...
.method private static varargs c(Lorg/bouncycastle/crypto/c$a;[Ljava/lang/Object;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p0}, Lorg/bouncycastle/crypto/c$a;->b(Lorg/bouncycastle/crypto/c$a;)Ljava/lang/Class;
    ...
    invoke-static {p0, p1}, Lorg/bouncycastle/crypto/c;->d(Lorg/bouncycastle/crypto/c$a;[Ljava/lang/Object;)V

    sget-object v0, Lorg/bouncycastle/crypto/c;->e:Ljava/util/Map;

    invoke-static {p0}, Lorg/bouncycastle/crypto/c$a;->a(Lorg/bouncycastle/crypto/c$a;)Ljava/lang/String;
...
.method private static d(Lorg/bouncycastle/crypto/c$a;[Ljava/lang/Object;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    sget-object v0, Lorg/bouncycastle/crypto/c;->d:Ljava/lang/ThreadLocal;
...
.method private static e(Lxg/e;)Lxg/b;
    .locals 9
    ...
    invoke-static {v0}, Lorg/bouncycastle/crypto/c;->a(I)I
    ...
    invoke-virtual {p0}, Lxg/e;->d()Lxg/g;

    move-result-object v1

    invoke-virtual {v1}, Lxg/g;->b()[B
    ...
    invoke-virtual {p0}, Lxg/g;->a()I

    move-result p0

    invoke-direct {v8, v1, p0}, Lxg/c;-><init>([BI)V

    move-object v1, v0

    invoke-direct/range {v1 .. v8}, Lxg/b;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;IILjava/math/BigInteger;Lxg/c;)V
