...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lorg/bouncycastle/crypto/PasswordConverter$a;

    const-string v1, "ASCII"

    const/4 v2, 0x0

    invoke-direct {v0, v1, v2}, Lorg/bouncycastle/crypto/PasswordConverter$a;-><init>(Ljava/lang/String;I)V

    sput-object v0, Lorg/bouncycastle/crypto/PasswordConverter;->ASCII:Lorg/bouncycastle/crypto/PasswordConverter;

    new-instance v1, Lorg/bouncycastle/crypto/PasswordConverter$b;

    const-string v3, "UTF8"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lorg/bouncycastle/crypto/PasswordConverter$b;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lorg/bouncycastle/crypto/PasswordConverter;->UTF8:Lorg/bouncycastle/crypto/PasswordConverter;

    new-instance v3, Lorg/bouncycastle/crypto/PasswordConverter$c;

    const-string v5, "PKCS12"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lorg/bouncycastle/crypto/PasswordConverter$c;-><init>(Ljava/lang/String;I)V
...
.method synthetic constructor <init>(Ljava/lang/String;ILorg/bouncycastle/crypto/PasswordConverter$a;)V
    .locals 0
