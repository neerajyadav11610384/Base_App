...
.method public static a(Landroid/content/Context;)Lcom/webengage/sdk/android/Analytics;
    ...
    new-instance v1, Lcom/webengage/sdk/android/d0;

    invoke-virtual {p0}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object v2

    invoke-direct {v1, v2}, Lcom/webengage/sdk/android/d0;-><init>(Landroid/content/Context;)V

    new-instance v2, Lcom/webengage/sdk/android/e0;

    invoke-virtual {p0}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object v3

    invoke-direct {v2, v0, v3}, Lcom/webengage/sdk/android/e0;-><init>(Lcom/webengage/sdk/android/f;Landroid/content/Context;)V

    new-instance v3, Lcom/webengage/sdk/android/d;

    invoke-direct {v3, p0, v0, v2, v1}, Lcom/webengage/sdk/android/d;-><init>(Landroid/content/Context;Lcom/webengage/sdk/android/f;Lcom/webengage/sdk/android/e0;Lcom/webengage/sdk/android/d0;)V
...
.method protected static a(Ljava/util/Queue;)Lcom/webengage/sdk/android/Analytics;
    ...
    new-instance v0, Lcom/webengage/sdk/android/a0;

    invoke-direct {v0, p0}, Lcom/webengage/sdk/android/a0;-><init>(Ljava/util/Queue;)V
